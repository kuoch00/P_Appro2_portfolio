        ...
        <div class="col-8 container-background ">
            <form method="POST" action="?admin=login">
                ...
                <div class="form-group row">
                    ...
                    <input type="email" class="form-control <?= isset($isInvalid) && $isInvalid==true ? "is-invalid" : ""?>" id="exampleInputEmail1" name="username" aria-describedby="emailHelp"  value= <?= isset($_POST['username'])!="" ? $_POST["username"] : "" ?>>
                </div>
                <div class="form-group row">
